...
CREATE TABLE IF NOT EXISTS `crm`.`clients` (
  ...
  `full_name` VARCHAR(255) NOT NULL,
  `active_groups` TEXT NULL DEFAULT NULL,
  `total_balance` DECIMAL(10,2) NULL DEFAULT 0,
  `bonus_account` INT NULL DEFAULT 0,
  `learning_status` VARCHAR(100) NULL DEFAULT NULL,
  `contacts` VARCHAR(255) NULL DEFAULT NULL,
  `next_visit_date` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
